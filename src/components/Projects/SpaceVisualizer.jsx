                ...
                {props => (
                    <div style={props}>
                        ...
                        <div className="project-about-section space-about-section">
                            <p className="overview-section"><strong>About:</strong> Solar System Visualizer was designed to be a fun and interactive way to learn about our solar system and the planets within it. This project was the first real project other than this portfolio that was created after my time at Eleven Fifty Academy. This project was built by myself and two others from my cohort at the academy in a little under two weeks. We decided to build this project to brush up on our data structures and also to build something that we are passionate about. This is only version 1.0 of this project to keep an eye out for updates!
                            </p>
